...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      ...
      secondary: "bg-gray-700 hover:bg-gray-600 text-gray-100 border border-gray-600 focus:ring-gray-500 focus:ring-offset-gray-900",
      text: "bg-transparent hover:bg-gray-800 text-gray-300 hover:text-gray-100 focus:ring-gray-500 focus:ring-offset-gray-900",
    };
